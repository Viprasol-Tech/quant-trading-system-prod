...
exports.TrendBreakoutStrategy = void 0;
...
class TrendBreakoutStrategy extends BaseStrategy_1.BaseStrategy {
                ...
                if (conditionsMet >= 5) {
                    ...
                    if (confidence >= this.minConfidence) {
                        ...
                        const signal = {
                            ...
                            riskAmount: new decimal_js_1.default(riskPerShare * 100), // Per 100 shares
    ...
    checkBreakoutSignal(analysis, currentPrice) {
...
exports.TrendBreakoutStrategy = TrendBreakoutStrategy;
//# sourceMappingURL=TrendBreakoutStrategy.js.map